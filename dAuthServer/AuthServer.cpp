...
int main(int argc, char** argv) {
	...
	Game::server = new dServer(ourIP, ourPort, 0, maxClients, false, true, Game::logger, masterIP, masterPort, ServiceId::Auth, Game::config, &Game::lastSignal, masterPassword);
