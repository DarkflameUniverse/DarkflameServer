...
inline Vector3 NiQuaternion::GetEulerAngles() const {
	Vector3 angles;
...
inline NiQuaternion NiQuaternion::LookAt(const NiPoint3& sourcePoint, const NiPoint3& destPoint) {
...
inline NiQuaternion NiQuaternion::LookAtUnlocked(const NiPoint3& sourcePoint, const NiPoint3& destPoint) {
...
inline NiQuaternion NiQuaternion::CreateFromAxisAngle(const Vector3& axis, float angle) {
...
inline NiQuaternion NiQuaternion::FromEulerAngles(const NiPoint3& eulerAngles) {
