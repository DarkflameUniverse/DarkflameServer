...
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ int ztdc_count_onesull(
...
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ int ztdc_first_leading_oneus(
     unsigned short value) ZTD_CXX_NOEXCEPT_I_;
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ int ztdc_first_leading_oneui(
     unsigned int value) ZTD_CXX_NOEXCEPT_I_;
...
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ bool ztdc_has_single_bituc(
     unsigned char value) ZTD_CXX_NOEXCEPT_I_;
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ bool ztdc_has_single_bitus(
     unsigned short value) ZTD_CXX_NOEXCEPT_I_;
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ bool ztdc_has_single_bitui(unsigned int value) ZTD_CXX_NOEXCEPT_I_;
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ bool ztdc_has_single_bitul(
     unsigned long value) ZTD_CXX_NOEXCEPT_I_;
...
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ unsigned short ztdc_bit_ceilus(
     unsigned short value) ZTD_CXX_NOEXCEPT_I_;
ZTD_IDK_C_LANGUAGE_LINKAGE_I_ ZTD_IDK_API_LINKAGE_I_ unsigned int ztdc_bit_ceilui(
     unsigned int value) ZTD_CXX_NOEXCEPT_I_;
