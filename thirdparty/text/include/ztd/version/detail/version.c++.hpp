...
// clang-format off
...
#elif ZTD_IS_ON(ZTD_CXX_I_) && __cplusplus > 201603L
	#define ZTD_STD_ALIGNED_OPERATOR_NEW_I_ ZTD_DEFAULT_ON
#else
	...
	#define ZTD_STD_TEXT_ENCODING_ID_I_ ZTD_DEFAULT_OFF
		...
		#define ZTD_STD_LIBRARY_ASSUME_ALIGNED_I_ ZTD_IS_ON
	#else
		#define ZTD_STD_LIBRARY_ASSUME_ALIGNED_I_ ZTD_IS_OFF
	#endif
#elif defined(__cpp_lib_assume_aligned)
	#define ZTD_STD_LIBRARY_ASSUME_ALIGNED_I_ ZTD_IS_DEFAULT_ON
#else
	#define ZTD_STD_LIBRARY_ASSUME_ALIGNED_I_ ZTD_IS_DEFAULT_OFF
#endif
...
#elif ZTD_IS_ON(ZTD_CXX_I_) && ZTD_IS_ON(ZTD_STD_LIBRARY_TEXT_ENCODING_ID_I_)
