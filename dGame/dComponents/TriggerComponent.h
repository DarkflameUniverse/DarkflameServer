...
public:
	constexpr static const eReplicaComponentType ComponentType = eReplicaComponentType::TRIGGER;

	explicit TriggerComponent(const LWOOBJID& parentEntityId, const std::string triggerInfo);
