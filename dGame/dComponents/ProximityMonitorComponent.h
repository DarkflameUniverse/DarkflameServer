...
public:
	constexpr static const eReplicaComponentType ComponentType = eReplicaComponentType::PROXIMITY_MONITOR;

	ProximityMonitorComponent(const LWOOBJID& parentEntityId, int smallRadius = -1, int largeRadius = -1);
