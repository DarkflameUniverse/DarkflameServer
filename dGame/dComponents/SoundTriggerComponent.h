...
public:
	constexpr static const eReplicaComponentType ComponentType = eReplicaComponentType::SOUND_TRIGGER;
	explicit SoundTriggerComponent(const LWOOBJID& parentEntityId);
