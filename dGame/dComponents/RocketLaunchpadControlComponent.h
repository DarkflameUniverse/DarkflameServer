...
public:
	constexpr static const eReplicaComponentType ComponentType = eReplicaComponentType::ROCKET_LAUNCH;

	RocketLaunchpadControlComponent(const LWOOBJID& parentEntityId, int rocketId);
